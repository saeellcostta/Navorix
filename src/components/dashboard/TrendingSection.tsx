      ...
      <div className="tc-card">
        <div className="tc-banner">
          {bgImage ? (
            ...
            <img src={bgImage} alt={token.name} className="tc-banner-img" />
          ) : (
    ...
    <>
      <style>{`
        ...
        .tc-rank {
          ...
          background: rgba(8,8,15,0.72); backdrop-filter: blur(4px);
        ...
        .tc-mcap { font-size: 1.05rem; font-weight: 800; color: #f9fafb; text-shadow: 0 1px 8px rgba(0,0,0,0.9); }
        .tc-change { font-size: 0.6875rem; font-weight: 700; border-radius: 999px; padding: 0.15rem 0.45rem; }
        ...
        .tc-info { display: flex; align-items: flex-start; gap: 0.6rem; padding: 0.7rem; }
        .tc-avatar {
        ...
        .tc-name {
          ...
          white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin: 0 0 0.2rem 0;
        }
        .tc-desc {
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-bold text-[var(--text-primary)]">{t.trending.title}</h2>
            </div>
